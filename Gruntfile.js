...
(function setUp(module, require) {
  ...
  var banner = ['/*!',
      ' * Kalki Utility v<%= pkg.version %>',
      ' *',
      ' * Released under the MIT license',
      ' * www.opensource.org/licenses/MIT',
      ' *',
      ' * Brought to you by Srijan Ghosh',
      ' *',
  ...
  module.exports = function doGrunt(grunt) {
    ...
    grunt.initConfig({
      ...
      'uglify': {
        'options': {
          'sourceMap': true,
          'sourceMapName': '<%= confs.dist %>/kalki-utility.sourcemap.map',
        ...
        'minifyTarget': {
          'files': {
            '<%= confs.dist %>/kalki-utility.min.js': [
              '<%= confs.js %>/kalki-utility.js'
            ]
          }
        }
      },
      'cssmin': {
        ...
        'minifyTarget': {
          'files': {
            '<%= confs.dist %>/kalki-utility.min.css': [
              '<%= confs.css %>/kalki-utility.css'
            ]
          }
        }
      },
